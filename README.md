...
The calorimetric cells allowing for heat flux monitoring for isothermal and DSC applications have been made from off-the-shelf components easily available at regular hardware and electronic stores. The adiabatic module is represented by a modified soil permeability test mould; however, water-tight container with cable-pass and an internal volume of around 2L can do the job.
